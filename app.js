...
var configPaths = [ path.join(os.homedir(), '.config', 'evrmore-rpc-explorer.env'), path.join(process.cwd(), '.env') ];
...
function getSourcecodeProjectMetadata() {
	var options = {
		url: "https://api.github.com/repos/evrmoreorg/evrmore-rpc-explorer",
		headers: {
			'User-Agent': 'request'
		}
	};
