...
const args = require('meow')(`
    ...
    Options
      ...
      -C, --coin <coin>              crypto-coin to enable [default: EVR]

      -b, --bitcoind-uri <uri>       connection URI for evrmored rpc (overrides the options below)
      -H, --bitcoind-host <host>     hostname for evrmored rpc [default: 127.0.0.1]
      -P, --bitcoind-port <port>     port for evrmored rpc [default: 8332]
      -c, --bitcoind-cookie <path>   path to evrmored cookie file [default: ~/.bitcoin/.cookie]
      -u, --bitcoind-user <user>     username for evrmored rpc [default: none]
      -w, --bitcoind-pass <pass>     password for evrmored rpc [default: none]
    ...
    Examples
      $ evrmore-rpc-explorer --port 8080 --bitcoind-port 18443 --bitcoind-cookie ~/.evrmore/regtest/.cookie
      $ evrmore-rpc-explorer -p 8080 -P 18443 -c ~/.evrmore/regtest.cookie

    Or using connection URIs
      $ evrmore-rpc-explorer -b bitcoin://bob:myPassword@127.0.0.1:18443/
      $ evrmore-rpc-explorer -b bitcoin://127.0.0.1:18443/?cookie=$HOME/.evrmore/regtest/.cookie

    All options may also be specified as environment variables
      $ BTCEXP_PORT=8080 BTCEXP_BITCOIND_PORT=18443 BTCEXP_BITCOIND_COOKIE=~/.evrmore/regtest/.cookie evrmore-rpc-explorer
